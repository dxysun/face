...
Bullet.prototype = {
	// 移动
	move:function(fps,isEnemy){

	    if(isEnemy)
	    {
	        this.y_int += this.vy_float/3/fps;
		    this.x_int += this.vx_float/3/fps;
	    }
	    else
	    {
	...
	//检查我机与敌机是否发生碰撞
	checkToEpBump:function(isEnemy){
		var o = this;
		if(isEnemy)
		{
		     if(Tools.checkIntersects(o.getRept(),this.gs.myPlane.getRept())&&this.gs.myPlane.hp_int>0&&o.isLife_bool){
			    	o.isLife_bool = false;
			    	this.gs.myPlane.hp_int -= o.hurt_int;
